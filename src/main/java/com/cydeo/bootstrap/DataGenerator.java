...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // This run method will be executed once the application runs before anything else

        // create some roles and put in DB(map in our case)

        // create users and put users in DB
